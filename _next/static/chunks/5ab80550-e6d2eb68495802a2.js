        ...
        50499: function(t, e, r) {
            ...
            var k = Object.defineProperty,
                ...
                F = (t, e) => {
                    ...
                    if (P)
                        for (var r of P(e)) T.call(e, r) && D(t, r, e[r]);
                    return t
                };
            let L = {
            ...
            ! function() {
                ...
                var R = function(t) {
                    var e, r, i, n, o, s, u, f, a, l, c, d, p, m, g, v, A, y, b, w, M, E, S, I, N, B, C, _, x, O, R, k, P, U, T, D, F, L, q, z, j, H, K, Q, J, G, Y, V, W, X, Z, $, tt, te, tr, ti, tn, to, ts, tu, tf, th, ta;
            ...
            ! function(t, e) {
                ...
                var m = function(t, e, r) {
                    ...
                    h = (o + (n >>> 13) | 0) + (tO >>> 26) | 0, tO &= 67108863, i = Math.imul(F, tf), n = (n = Math.imul(F, th)) + Math.imul(L, tf) | 0, o = Math.imul(L, th), i = i + Math.imul(U, tl) | 0, n = (n = n + Math.imul(U, tc) | 0) + Math.imul(T, tl) | 0, o = o + Math.imul(T, tc) | 0, i = i + Math.imul(R, tp) | 0, n = (n = n + Math.imul(R, tm) | 0) + Math.imul(k, tp) | 0, o = o + Math.imul(k, tm) | 0;
                    var tR = (h + i | 0) + ((8191 & n) << 13) | 0;
                    h = (o + (n >>> 13) | 0) + (tR >>> 26) | 0, tR &= 67108863, i = Math.imul(F, tl), n = (n = Math.imul(F, tc)) + Math.imul(L, tl) | 0, o = Math.imul(L, tc), i = i + Math.imul(U, tp) | 0, n = (n = n + Math.imul(U, tm) | 0) + Math.imul(T, tp) | 0, o = o + Math.imul(T, tm) | 0;
            ...
            class tq {
                constructor(t, e) {
                    t !== tF && tD.throwError("cannot call constructor directly; use BigNumber.from", tA.errors.UNSUPPORTED_OPERATION, {
                ...
                toBigInt() {
                    ...
                    return tD.throwError("this platform does not support BigInt", tA.errors.UNSUPPORTED_OPERATION, {
                        value: this.toString()
                    })
                }
                toString() {
                    return arguments.length > 0 && (10 === arguments[0] ? tL || (tL = !0, tD.warn("BigNumber.toString does not accept any parameters; base-10 is assumed")) : 16 === arguments[0] ? tD.throwError("BigNumber.toString does not accept any parameters; use bigNumber.toHexString()", tA.errors.UNEXPECTED_ARGUMENT, {}) : tD.throwError("BigNumber.toString does not accept parameters", tA.errors.UNEXPECTED_ARGUMENT, {})), tH(this).toString(10)
                }
                toHexString() {
                    return this._hex
                }
                ...
                static from(t) {
                    ...
                    if ("string" == typeof t) return t.match(/^-?0x[0-9a-f]+$/i) ? new tq(tF, tz(t)) : t.match(/^-?[0-9]+$/) ? new tq(tF, tz(new tT(t))) : tD.throwArgumentError("invalid BigNumber string", "value", t);
            ...
            function tz(t) {
                ...
                if ("-" === t[0]) return "-" === (t = t.substring(1))[0] && tD.throwArgumentError("invalid hex", "value", t), "0x00" === (t = tz(t)) ? t : "-" + t;
            ...
            function tH(t) {
                ...
                return "-" === e[0] ? new tT("-" + e.substring(3), 16) : new tT(e.substring(2), 16)
            }
            ...
            function tK(t, e, r) {
                ...
                return null != r && (i.value = r), tD.throwError(t, tA.errors.NUMERIC_FAULT, i)
            }
            let tQ = new tA(tU),
                tJ = {},
                tG = tq.from(0),
...
`;
            ...
            em.inherits(eJ, eK), eJ.blockSize = 512, eJ.outSize = 256, eJ.hmacStrength = 192, eJ.padLength = 64, eJ.prototype._update = function(t, e) {
                for (var r = this.W, i = 0; i < 16; i++) r[i] = t[e + i];
                for (; i < r.length; i++) r[i] = eT(eH(r[i - 2]), r[i - 7], ej(r[i - 15]), r[i - 16]);
                var n = this.h[0],
                    o = this.h[1],
                    s = this.h[2],
                    u = this.h[3],
            ...
            rk.prototype._importDER = function(t, e) {
                ...
                var e = this.r.toArray(),
                    r = this.s.toArray();
                for (128 & e[0] && (e = [0].concat(e)), 128 & r[0] && (r = [0].concat(r)), e = rT(e), r = rT(r); !r[0] && !(128 & r[1]);) r = r.slice(1);
                var i = [2];
                        ...
                        return s = r.s, (function(t) {
                            ...
                            if ("string" != typeof t && eu.throwArgumentError("invalid address", "address", t), t.match(/^(0x)?[0-9a-fA-F]{40}$/)) "0x" !== t.substring(0, 2) && (t = "0x" + t), e = ef(t), t.match(/([A-F].*[a-f])|([a-f].*[A-F])/) && e !== t && eu.throwArgumentError("bad address checksum", "address", t);
                                ...
                                for (t.substring(2, 4) !== function(t) {
                                        ...
                                        return r
                                    }(t) && eu.throwArgumentError("bad icap checksum", "address", t), e = new tT(t.substring(4), 36).toString(16); e.length < 40;) e = "0" + e;
                                e = ef("0x" + e)
...
`)
            ...
            function iL(t) {
                return `${t.protocol}:${t.topic}@${t.version}?` + b.stringify(iT(iD(iT({
                    symKey: t.symKey
                }, function(t, e = "-") {
                    let r = {};
                    return Object.keys(t).forEach(i => {
