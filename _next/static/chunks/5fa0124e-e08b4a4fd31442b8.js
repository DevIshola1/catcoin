        ...
        57709: function(e, t, i) {
            ...
            function Z(e, t) {
                let {
                    ...
                    width: 350,
                    height: 500
                }, n = (window.innerHeight - i) / 2, a = (window.innerWidth - s) / 2, l = window.open("", void 0, `width=${s}, height=${i}, top=${n}, left=${a}`);
                if (l) {
                    let i = "google" === e ? "Sign In - Google Accounts" : `Sign In - ${e.slice(0,1).toUpperCase()}${e.slice(1)}`;
                    l.document.title = i, l.document.body.innerHTML = v, l.document.body.style.background = t.colors.modalBg, l.document.body.style.color = t.colors.accentText
                }
                return l && window.addEventListener("beforeunload", () => {
                    l ? .close()
                }), l
            }
            let v = `
...
`;
            ...
            function W(e) {
                ...
                return (0, r.useEffect)(() => {
                    a.current[s] && requestAnimationFrame(() => {
                        a.current[s] ? .focus()
                    })
                }, [s]), (0, c.jsx)(n.C, {
                    center: "x",
                    gap: "sm",
                    flex: "row",
                    children: Array(e.digits).fill(null).map((n, l) => (0, c.jsx)(B, {
                        ...
                        inputMode: "text",
                        onPaste: t => {
                            i(t.clipboardData.getData("text/plain").slice(0, e.digits).split("")), t.preventDefault()
                        },
                        onKeyDown: s => {
                            if ("Enter" === s.key && e.onEnter) {
                                e.onEnter();
                                return
                            }
                            if ("ArrowLeft" === s.key) {
...
`;
            let Q = e => {
                let t = (0, n.c)().wallets.localWallet,
                    [i, a] = (0, r.useState)(""),
                    [o, C] = (0, r.useState)(!1),
                    [d, M] = (0, r.useState)(!1),
                    [j, x] = (0, r.useState)(!1),
                    ...
                    T = (0, r.useRef)(!1);
                (0, r.useEffect)(() => {
                    T.current || (T.current = !0, (async () => {
                        if (g && g instanceof D.S) {
                            y && N(y);
                            let e = await g.getSavedData();
                            e ? .address !== y && x(!0)
                        } else {
                            let t = h(e.localWalletConfig),
                                i = await t.getSavedData();
                            i && N(i.address)
                        }
                    })())
                }, [g, e.localWalletConfig, h, i, y]);
                let m = async () => {
                    if (g && g instanceof D.S) {
                        let t = await g.getSavedData();
                        if (t && t.address === y) P(t.data), e.onExport();
                        else try {
                            let t = await g.export({
                                password: i,
                        ...
                        let t = h(e.localWalletConfig);
                        P((await t.getSavedData()).data), e.onExport()
                    }
                };
                return u ? (0, c.jsx)(n.C, {
                    fullHeight: !0,
                    animate: "fadein",
                    children: (0, c.jsxs)("form", {
                        ...
                        children: [(0, c.jsx)(n.C, {
                            p: "lg",
                            children: (0, c.jsx)(n.M, {
                                onBack: e.onBack,
                                title: t.exportScreen.title
                            })
                        }), (0, c.jsx)(n.L, {}), (0, c.jsxs)(n.C, {
                            expand: !0,
                            p: "lg",
                            children: [(0, c.jsx)(n.d, {
                                children: t.exportScreen.description1
                            }), (0, c.jsx)(n.S, {
                                y: "sm"
                            }), (0, c.jsx)(n.d, {
                                children: t.exportScreen.description2
                            }), (0, c.jsx)(n.S, {
                                y: "xl"
                            }), (0, c.jsx)(n.f, {
                                children: t.exportScreen.walletAddress
                            }), (0, c.jsx)(n.S, {
                                y: "sm"
                            }), (0, c.jsx)(G, {
                                children: (0, l.XnK)(u)
                            }), j && (0, c.jsxs)(c.Fragment, {
                                children: [(0, c.jsx)(n.S, {
                                    y: "lg"
                                }), (0, c.jsx)("input", {
                                    type: "text",
                                    name: "username",
                                    ...
                                    right: {
                                        onClick: () => C(!o),
                                        icon: o ? (0, c.jsx)(s.LAO, {}) : (0, c.jsx)(s.hsE, {})
                                    },
                            ...
                            children: (0, c.jsxs)(n.B, {
                                ...
                                type: "submit",
                                children: [(0, c.jsx)(s.RgI, {
                                    width: n.a.sm,
                                    height: n.a.sm
                                }), t.exportScreen.download]
                            })
                        })]
                    })
                }) : (0, c.jsx)(n.C, {
            ...
            function P(e) {
                let t = new Blob([JSON.stringify(JSON.parse(e), null, 2)], {
                        type: "application/json"
                    }),
                    i = URL.createObjectURL(t),
                    s = document.createElement("a");
                s.href = i, s.download = "wallet.json", document.body.appendChild(s), s.style.display = "none", s.click(), URL.revokeObjectURL(s.href)
            }
            let G = (0, n.E)(() => {
                    let e = (0, n.u)();
                    return {
                ...
                H = "ipfs://QmcxZHpyJa8T4i63xqjPYrZ6tKrt55tZJpbXcjSDKuKaf9/ethereum/512.png",
                F = e => {
                    let t = e.chain ? .icon ? .url || H,
                        i = (0, l.y$C)(),
                    ...
                    return (0, c.jsxs)("div", {
                        ...
                        children: [(0, c.jsx)("img", {
                            src: s || H,
                            onError: e => {
                                e.currentTarget.src !== H && (e.currentTarget.src = H)
                            },
                            alt: "",
                            width: e.size,
                            height: e.size,
            ...
            let X = e => {
                    ...
                    return (0, c.jsx)("div", {
                        ...
                        children: (0, c.jsx)(a.T, {
                            ...
                            side: e.side,
                            align: e.align,
                            children: e.hasCopied || t ? (0, c.jsx)(J, {}) : (0, c.jsx)(s.TIy, {})
                        })
                    })
                },
                J = (0, j.Z)(s.nQG)(() => ({
                    color: (0, n.u)().colors.success
                })),
                $ = (0, M.F4)
            `
 from {
...
`, _ = (0, n.b)(() => ({
                backgroundColor: (0, n.u)().colors.modalOverlayBg,
                zIndex: 9999,
                position: "fixed",
                inset: 0,
            ...
            let q = e => {
                    let [t, i] = (0, r.useState)(e.open), l = (0, r.useRef)(null), o = (0, r.useRef)(null);
                    return (0, r.useEffect)(() => {
                        if (e.open) i(e.open);
                        else if (l.current) {
                            let e = {
                    ...
                    }, [e.open]), (0, c.jsxs)(z.fC, {
                        open: t,
                        onOpenChange: e.setOpen,
                        children: [e.trigger && (0, c.jsx)(z.xz, {
                            asChild: !0,
                            children: e.trigger
                        }), (0, c.jsxs)(z.h_, {
                            children: [!e.hide && (0, c.jsx)(z.aV, {
                                asChild: !0,
                                children: (0, c.jsx)(_, {
                                    ref: o
                                })
                                ...
                                trapped: !e.hide,
                                children: (0, c.jsx)(z.VY, {
                                    asChild: !0,
                                    children: (0, c.jsxs)(es, {
                                        ref: l,
                                        style: e.hide ? {
                                            width: 0,
                                            height: 0,
                                            ...
                                            height: "compact" === e.size ? "auto" : a.w,
                                            maxWidth: "compact" === e.size ? a.b : a.c
                                        },
                                        children: ["compact" === e.size ? (0, c.jsxs)(K, {
                                            maxHeight: a.d,
                                            children: [e.children, " "]
                                        }) : e.children, !e.hideCloseIcon && (0, c.jsx)(ee, {
                                            children: (0, c.jsx)(z.x8, {
                                                asChild: !0,
                                                children: (0, c.jsx)(n.z, {
                                                    type: "button",
                                                    "aria-label": "Close",
                                                    children: (0, c.jsx)(s.Pxu, {
                                                        width: n.a.md,
                                                        height: n.a.md,
                                                        style: {
                                                            color: "inherit"
...
`, es = (0, n.b)(() => {
                ...
                return {
                    ...
                    [n.w.mobile]: {
                        ...
                        transform: "none",
                        width: "100vw",
                        animation: `${ei} 0.35s cubic-bezier(0.15, 1.15, 0.6, 1)`,
                        borderRadius: n.r.xxl,
                        borderBottomRightRadius: 0,
                        borderBottomLeftRadius: 0,
                        maxWidth: "none !important"
                    },
                    "& *::selection": {
                        backgroundColor: e.colors.selectedTextBg,
                        color: e.colors.selectedTextColor
                    },
                    ...n.G
                }
            }), en = e => (0, c.jsx)(el, {
...
`, el = (0, n.b)(() => ({
                ...
                backgroundColor: (0, n.u)().colors.skeletonBg,
                animation: `${ea} 500ms ease-in-out infinite alternate`,
                borderRadius: n.r.sm
            })), er = {
                threshold: .4,
                keys: [{
            ...
            function ec(e) {
                let [t, i] = (0, r.useState)(""), s = (0, r.useDeferredValue)(t), a = (0, l.EnH)(), o = e.chains || a, C = (0, n.c)().connectWallet.networkSelector, d = e.recentChains, M = d ? e.popularChains ? .filter(e => !d.some(t => t.chainId === e.chainId)) : e.popularChains, j = (0, r.useMemo)(() => new N.Z(o, er), [o]), x = (0, r.useMemo)(() => new N.Z(M || [], er), [M]), g = (0, r.useMemo)(() => new N.Z(e.recentChains || [], er), [e.recentChains]), h = (0, r.useMemo)(() => "" === s ? o : j.search(s).map(e => e.item), [j, s, o]), D = (0, r.useMemo)(() => "" === s ? M || [] : x.search(s).map(e => e.item), [x, s, M]), y = (0, r.useMemo)(() => "" === s ? e.recentChains || [] : g.search(s).map(e => e.item), [g, s, e.recentChains]), {
                    onClose: T,
                    onSwitch: m,
                    onCustomClick: I
                ...
                return (0, c.jsxs)(n.C, {
                    children: [(0, c.jsx)(n.C, {
                        ...
                        children: [(0, c.jsx)(n.C, {
                            ...
                            y: "lg"
                        }), o.length > 10 && (0, c.jsxs)(c.Fragment, {
                            children: [(0, c.jsx)(n.C, {
                                px: "lg",
                                children: (0, c.jsxs)("div", {
                                    ...
                                    children: [(0, c.jsx)(eu, {
                                        ...
                                        style: {
                                            padding: `${n.s.sm} ${n.s.md} ${n.s.sm} ${n.s.xxl}`
                                        },
                                        tabIndex: -1,
                                        variant: "outline",
                            ...
                            children: [(0, c.jsx)(n.L, {}), (0, c.jsx)(n.C, {
                                p: "lg",
                                children: (0, c.jsx)(n.B, {
                                    fullWidth: !0,
                                    variant: "link",
                                    onClick: () => {
                                        I(), T && T()
            ...
            let eo = (e, t) => "all" === t ? e : "testnet" === t ? e.filter(e => e.testnet) : e.filter(e => !e.testnet),
                eC = e => {
                    let t = (0, r.useMemo)(() => eo(e.allChains, e.type), [e.type, e.allChains]),
                        i = (0, r.useMemo)(() => eo(e.recentChains || [], e.type), [e.type, e.recentChains]),
                        s = (0, r.useMemo)(() => eo(e.popularChains || [], e.type), [e.type, e.popularChains]),
                        a = (0, n.c)().connectWallet.networkSelector.categoryLabel;
                    return (0, c.jsxs)(n.C, {
                        scrollY: !0,
                        animate: "fadein",
                        style: {
                            height: "330px",
                            paddingBottom: n.s.lg
                        },
                        children: [i.length > 0 && (0, c.jsxs)("div", {
                            children: [(0, c.jsx)(ej, {
                                children: a.recentlyUsed
                            }), (0, c.jsx)(n.S, {
                                y: "sm"
                            }), (0, c.jsx)(ed, {
                                chains: i,
                ...
                ed = (0, r.memo)(function(e) {
                    let t = (0, l.o$C)(),
                        i = (0, l.xxU)(),
                        [s, a] = (0, r.useState)(-1),
                        [o, C] = (0, r.useState)(-1),
                        d = (0, n.c)(),
                        M = d.connectWallet.networkSelector,
                        j = e.close;
                    (0, r.useEffect)(() => {
                        -1 !== s && i === s && j && j()
                    }, [s, j, i]);
                    let x = async i => {
                            ...
                            try {
                                ...
                                C(i.chainId), console.error(e)
                            } finally {
                                a(-1)
                            }
                        },
                        g = e.renderChain,
                        [u, N] = (0, r.useState)(e.chains.length > 100);
                    return ((0, r.useEffect)(() => {
                        u && setTimeout(() => {
                        ...
                        px: "xxs",
                        children: (0, c.jsx)(ex, {
                            children: Array(10).fill(0).map((e, t) => (0, c.jsx)(en, {
                                height: "48px"
                            }, t))
                        })
                    }) : (0, c.jsx)(ex, {
                                        ...
                                        children: [r, (0, c.jsxs)(n.C, {
                                            ...
                                            children: [a && (0, c.jsxs)(c.Fragment, {
                                                children: [(0, c.jsx)(n.T, {
                                                    size: "xs",
                                                    color: "accentText",
                                                    children: d.connectWallet.confirmInWallet
                                                }), (0, c.jsx)(n.e, {
                                                    size: "xs",
                                                    color: "accentText"
                                                })]
                ...
                eu = (0, j.Z)(s._Ve)(() => ({
                    color: (0, n.u)().colors.secondaryText,
                    position: "absolute",
                    left: n.s.sm
                })),
                eN = e => {
            ...
            function eh(e) {
                let t;
                let [i, s] = (0, r.useState)("base"), n = (0, l.xxU)();
                if (n && e.supportedTokens[n] && e.supportedTokens[n] !== U[n]) {
                    let i = e.supportedTokens[n],
                        s = i && i[0];
                    s && (t = s)
                }
                let [a, o] = (0, r.useState)(t), [C, d] = (0, r.useState)(""), [M, j] = (0, r.useState)("0");
                return "tokenSelector" === i ? (0, c.jsx)(ey, {
            ...
            function eD(e) {
                let t = (0, n.c)().connectWallet.sendFundsScreen,
                    i = e.token ? .address,
                    a = (0, l.KQd)(i),
                    {
                        receiverAddress: C,
                    ...
                    N = 1 === g || 5 === g || 4 === g,
                    h = (0, r.useMemo)(() => {
                        let e = C.endsWith(".eth");
                        return (!!N || !e) && (e || L.isAddress(C))
                    }, [C, N]),
                    D = C && !h,
                    y = (0, o.D)(async () => {
                        if (u) return u.transfer(C, M, i)
                    });
                if (y.isError) return (0, c.jsxs)(n.C, {
                    p: "lg",
                    animate: "fadein",
                    children: [(0, c.jsx)(n.M, {
                        title: t.title,
                        ...
                        color: "danger",
                        children: [(0, c.jsx)(s.xrR, {
                            width: n.a.xl,
                            height: n.a.xl
                        }), (0, c.jsx)(n.T, {
                            color: "danger",
                            children: function(e) {
                                let i = e ? .data ? .message || e ? .message;
                                return i ? i.includes("user rejected") ? t.transactionRejected : i.includes("insufficient funds") ? t.insufficientFunds : t.transactionFailed : t.transactionFailed
                            }(y.error)
                        })]
                    })]
                });
                if (y.isSuccess) return (0, c.jsxs)(n.C, {
                    p: "lg",
                    animate: "fadein",
                    children: [(0, c.jsx)(n.M, {
                        title: t.title,
                ...
                let T = e.token ? .name || a ? .data ? .name,
                    m = e.token ? .symbol || a.data ? .symbol;
                return (0, c.jsxs)(n.C, {
                    p: "lg",
                    animate: "fadein",
                    children: [(0, c.jsx)(n.M, {
                        ...
                        children: [(0, c.jsx)(n.f, {
                            ...
                            children: [y.isLoading ? t.sending : t.submitButton, y.isLoading && (0, c.jsx)(n.e, {
                                size: "sm",
            ...
            function ey(e) {
                let [t, i] = (0, r.useState)(""), a = (0, l.xxU)(), o = function() {
                    let e = (0, l.KQd)(),
                        t = (0, l.AbE)();
                    if (e.data) return {
                        name: e.data.name,
                    ...
                    let t = (0, l.KQd)(e),
                        i = (0, l.AbE)();
                    return L.isAddress(e) ? t.isLoading ? {
                        isLoading: !0,
                        data: void 0
                    } : t.data ? {
                        isLoading: !1,
                ...
                }(t), M = (0, n.c)().connectWallet.sendFundsScreen, j = (a ? e.supportedTokens[a] : void 0) || [];
                o && (j = [o, ...j]), C && (j = [C, ...j]);
                let x = t ? j.filter(e => {
                    let i = t.toLowerCase();
                ...
                return (0, c.jsxs)(n.C, {
                    animate: "fadein",
                    children: [(0, c.jsxs)(n.C, {
                        p: "lg",
                        children: [(0, c.jsx)(n.M, {
                            onBack: e.onBack,
                            title: M.selectTokenTitle
                        }), (0, c.jsx)(n.S, {
                            y: "xl"
                        }), (0, c.jsx)(n.v, {
                            placeholder: M.searchToken,
                            variant: "outline",
                            value: t,
                            onChange: e => {
                                i(e.target.value)
            ...
            function eT(e) {
                ...
                return (0, c.jsxs)(em, {
                    ...
                    variant: "secondary",
                    onClick: e.onClick,
                    children: [e.token ? .icon ? (0, c.jsx)(n.I, {
                        width: n.a.lg,
                        height: n.a.lg,
                        src: e.token.icon
                    }) : (0, c.jsx)(F, {
            ...
            function ew(e) {
                let t = (0, l.SFn)(),
                    ...
                    a = (0, n.c)().connectWallet.receiveFundsScreen;
                return (0, c.jsxs)(n.C, {
                    p: "lg",
                    children: [(0, c.jsx)(n.M, {
                        title: a.title,
            ...
            let ez = (0, n.A)(() => {
                    ...
                    return {
                        ...
                        "&:hover": {
                            borderColor: e.colors.accentText
                        }
                    }
                }),
                ep = "tw-connected-wallet",
                eS = e => {
                    let t = (0, n.c)().connectWallet,
                        i = (0, l.AbE)(),
                        o = (0, l.xxU)(),
                        C = (0, l.qL0)(),
                        d = (0, l.EnH)(),
                        M = (0, l.SFn)(),
                        j = o && e.displayBalanceToken ? e.displayBalanceToken[o] : void 0,
                        x = (0, l.KQd)(j),
                        g = (0, l.Osb)(),
                        u = (0, l.w_p)(),
                        N = (0, l.UvD)(),
                        D = (0, l.tNP)(),
                        m = g ? D.getWrapperWallet(g) : void 0,
                        [I, L] = (0, r.useState)(void 0),
                        [w, z] = (0, r.useState)("main"),
                        [p, S] = (0, r.useState)(!1),
                        A = (0, l.eC)(),
                        b = g ? .getPersonalWallet(),
                        f = b && D.getWalletConfig(b),
                        E = m && D.getWalletConfig(m),
                        k = !!b,
                        Y = g && g instanceof T.t,
                        O = M ? (0, l.SyX)(M, !1) : "",
                        U = N.data ? .ens || O,
                        Z = N.data ? .avatarUrl;
                    (0, r.useEffect)(() => {
                        g ? g.walletId === y.w.embeddedWallet ? g.getLastUsedAuthStrategy().then(e => {
                            "apple" === e ? L(a.a) : "google" === e ? L(a.g) : "facebook" === e ? L(a.f) : L(void 0)
                        }) : g.walletId === y.w.smartWallet ? L(a.s) : L(void 0) : L(void 0)
                    }, [g]), (0, r.useEffect)(() => {
                        p || (0, a.o)(() => {
                            z("main")
                        })
                    }, [p]);
                    let v = I || u ? .meta.iconURL || "",
                        W = Z || v,
                        B = e.detailsBtn ? (0, c.jsx)("div", {
                            children: (0, c.jsx)(e.detailsBtn, {})
                        }) : (0, c.jsxs)(eA, {
                            type: "button",
                            className: `${ep} ${e.className||""}`,
                            style: e.style,
                            "data-test": "connected-wallet-details",
                            children: [(0, c.jsx)(n.I, {
                                width: n.a.lg,
                                height: n.a.lg,
                                src: W,
                                className: `${ep}__wallet-icon`,
                                style: {
                                    borderRadius: n.r.sm
                                }
                            }), (0, c.jsxs)(n.C, {
                                flex: "column",
                                gap: "xxs",
                                children: [g ? .walletId === y.w.localWallet ? (0, c.jsx)(n.T, {
                                    color: "danger",
                                    size: "xs",
                                    style: {
                                        minWidth: "70px"
                                    ...
                                    color: "primaryText",
                                    weight: 500,
                                    className: `${ep}__address`,
                                    children: U
                                }) : (0, c.jsx)(en, {
                                    height: n.h.sm,
                                    width: "88px"
                                }), x.data ? (0, c.jsxs)(n.T, {
                                    className: `${ep}__balance`,
                                    size: "xs",
                                    weight: 500,
                                    children: [Number(x.data.displayValue).toFixed(3), " ", x.data.symbol]
                                }) : (0, c.jsx)(en, {
                                    height: n.h.xs,
                                    width: "82px"
                                })]
                        ...
                        P = (0, c.jsxs)(eb, {
                            ...
                            children: [(0, c.jsx)("div", {
                                ...
                                color: "primaryText",
                                multiline: !0,
                                children: i ? .name || `Unknown chain #${o}`
                            }), (0, c.jsx)(eE, {
                                width: n.a.sm,
                                height: n.a.sm,
                                style: {
                        ...
                        G = void 0 !== e.hideTestnetFaucet && !e.hideTestnetFaucet,
                        H = (0, c.jsxs)("div", {
                            children: [(0, c.jsx)(n.S, {
                                y: "xl"
                            }), (0, c.jsxs)(n.C, {
                                ...
                                children: [(0, c.jsx)(n.I, {
                                    ...
                                    weight: 500,
                                    size: "sm",
                                    children: [" ", x.data ? Number(x.data.displayValue).toFixed(3) : (0, c.jsx)(en, {
                                        height: "1em",
                                        width: "100px"
                                    }), " ", x.data ? .symbol, " "]
                                })]
                                ...
                                px: "lg",
                                children: [(0, c.jsx)(eO, {}), (0, c.jsx)(eU, {}), (0, c.jsxs)(n.C, {
                                    style: {
                                        display: "grid",
                                ...
                                children: [(0, c.jsxs)(n.C, {
                                    ...
                                    children: [P, b && f && !e.hideSwitchToPersonalWallet && (0, c.jsx)(ek, {
                                        wallet: b,
                                        name: t.personalWallet
                                    }), E && m && (0, c.jsx)(ek, {
                                        name: m.walletId === y.w.smartWallet ? t.smartWallet : E.meta.name,
                                        wallet: m
                                    }), Y && u && u.isInstalled && u.isInstalled() && !(0, n.i)() && (0, c.jsxs)(eb, {
                                        type: "button",
                                        onClick: () => {
                                            g.switchAccount(), S(!1)
                                        },
                                        children: [(0, c.jsx)(s.jH6, {
                                            width: n.a.md,
                                            height: n.a.md
                                        }), (0, c.jsx)(n.T, {
                                            color: "primaryText",
                                    ...
                                    }), G && (i ? .faucets && i.faucets.length > 0 || i ? .chainId === h.YY$.chainId) && (0, c.jsxs)(ef, {
                                        href: i ? .faucets ? i.faucets[0] : "#",
                                        target: "_blank",
                                        as: "a",
                                        onClick: async e => {
                                            i.chainId === h.YY$.chainId && (e.preventDefault(), S(!1), await A ? .wallet.requestFunds(10), await x.refetch())
                                        },
                                        style: {
                                            textDecoration: "none",
                                            color: "inherit"
                                        ...
                                        }), t.requestTestnetFunds]
                                    }), i ? .explorers && i.explorers[0] ? .url && (0, c.jsxs)(ef, {
                                        href: i.explorers[0].url + "/address/" + M,
                                        target: "_blank",
                                        as: "a",
                                        style: {
                                            textDecoration: "none",
                                        ...
                                        children: [(0, c.jsx)(n.C, {
                                            ...
                                            center: "y",
                                            color: "secondaryText",
                                            children: (0, c.jsx)(s.ux3, {
                                                width: n.a.md,
                                                height: n.a.md
                                            })
                                        }), t.transactionHistory]
                                    }), g ? .walletId === y.w.localWallet && (0, c.jsx)("div", {
                            ...
                            }), !0 !== e.hideDisconnect && (0, c.jsxs)(n.C, {
                                children: [(0, c.jsx)(n.L, {}), (0, c.jsx)(n.S, {
                                    y: "sm"
                                }), (0, c.jsx)(n.C, {
                                    px: "md",
                                    children: (0, c.jsxs)(eb, {
                            ...
                            }), g ? .walletId === y.w.localWallet && (0, c.jsxs)(c.Fragment, {
                                children: [(0, c.jsx)(n.L, {}), (0, c.jsx)(n.C, {
                                    py: "md",
                                    children: (0, c.jsx)(n.T, {
                                        size: "xs",
                                        ...
                                        color: "danger",
                                        balance: !0,
                                        children: t.guestWalletWarning
                                    })
                                })]
                            })]
                        });
                    return "network-switcher" === w ? H = (0, c.jsx)(ec, {
                        open: !0,
                        theme: e.theme,
                        chains: d,
                        ...e.networkSelector,
                ...
                eA = (0, n.A)(() => {
                    ...
                    return {
                        all: "unset",
                        background: e.colors.connectedButtonBg,
                        border: `1px solid ${e.colors.borderColor}`,
                        padding: `${n.s.sm} ${n.s.sm}`,
                        borderRadius: n.r.lg,
                        cursor: "pointer",
                        ...
                        "&:hover": {
                            ...
                            background: e.colors.connectedButtonBgHover
                        }
                    }
                }),
                eb = (0, n.A)(() => {
                    ...
                    return {
                        ...
                        "&:hover": {
                            backgroundColor: e.colors.walletSelectorButtonHoverBg,
                            transform: "scale(1.01)",
                            svg: {
                                color: e.colors.accentText
                            }
                        },
                        "&[disabled]": {
                            cursor: "not-allowed",
                        ...
                        "&[data-variant='danger']:hover svg": {
                            color: e.colors.danger + "!important"
                        },
                        "&[data-variant='primary']:hover svg": {
                            color: e.colors.primaryText + "!important"
                        }
                    }
                }),
                ef = eb.withComponent("a"),
                eE = (0, j.Z)(s.XCv)(() => ({
                    color: (0, n.u)().colors.secondaryText
                }));
            ...
            function ek(e) {
                let {
                    wallet: t,
                    name: i
                } = e, a = (0, l.tNP)(), r = (0, n.c)().connectWallet;
                return (0, c.jsxs)(eb, {
                    type: "button",
                    onClick: () => {
                        a.setConnectedWallet(t)
                    },
                    style: {
                        fontSize: n.h.sm
                    },
                    children: [(0, c.jsx)(s.m50, {
                        width: n.a.md,
                        height: n.a.md
                    }), (0, c.jsxs)(n.T, {
                        color: "primaryText",
                        children: [r.switchTo, " ", i]
                    })]
                })
            }
            let eY = (0, n.b)(() => ({
                ...
                height: "8px",
                borderRadius: "50%",
                backgroundColor: (0, n.u)().colors.success
            }));
            ...
            function eO() {
                let e = (0, l.Osb)(),
                    t = (0, l.AbE)(),
                    i = (0, l.SFn)(),
                    s = (0, n.c)().connectWallet,
                    [a, o] = (0, r.useState)(!1);
                (0, r.useEffect)(() => {
                    e && e.walletId === y.w.smartWallet ? e.isDeployed().then(e => {
                        o(e)
                    }) : o(!1)
                }, [e]);
                let C = (0, c.jsxs)(n.C, {
                    ...
                    gap: "xxs",
                    center: "both",
                    children: [(0, c.jsx)(eY, {}), s.connectedToSmartWallet]
                });
                return t && i && e ? .walletId === y.w.smartWallet ? (0, c.jsxs)(c.Fragment, {
                    children: [a ? (0, c.jsx)(n.N, {
                        color: "secondaryText",
            ...
            function eU() {
                let e = function() {
                    let e = (0, l.Osb)(),
                        t = (0, C.NL)(),
                        i = (0, d.a)([e ? .walletId, "embeddedWallet-email"], () => {
                            if (e && e.walletId === y.w.embeddedWallet) return e.getEmail()
                        }, {
                            retry: !1,
                            enabled: e ? .walletId === y.w.embeddedWallet
                        });
                    return (0, r.useEffect)(() => {
                        t.invalidateQueries([e ? .walletId, "embeddedWallet-email"])
                    }, [e, t]), i
                }();
                if (e.data) return (0, c.jsx)(n.C, {
                    flex: "row",
                    center: "x",
                    style: {
                        paddingBottom: n.s.md
                    },
                    children: (0, c.jsx)(n.T, {
                        size: "sm",
                        children: e.data
            ...
            let eZ = e => (0, c.jsx)("svg", {
                ...
                ev = e => {
                    let {
                        ...
                        termsOfServiceUrl: a,
                        privacyPolicyUrl: o
                    } = e, C = (0, n.c)().connectWallet.signatureScreen, d = (0, l.w_p)(), M = (0, l.Osb)(), {
                        auth: j
                    } = (0, r.useContext)(n.g), [x, g] = (0, r.useState)("idle"), {
                        login: u
                    } = (0, l.f0v)(), [N, h] = (0, r.useState)(0), D = (0, l.qL0)(), T = M ? .walletId === y.w.safe, m = (0, l.xxU)(), L = (0, l.SFn)(), w = m && m in I.s ? I.s[m] : void 0, z = (0, r.useCallback)(async () => {
                        try {
                            g("signing"), await (0, I.w)(1e3);
                            let e = await u();
                            j ? .onLogin ? .(e), t()
                        } catch (e) {
                            g("failed"), console.error("failed to log in", e)
                        }
                    }, [j, u, t]);
                    return d && M ? d ? .isHeadless ? (0, c.jsx)(eB, {
                        signIn: z,
                        status: x
                    }) : (0, c.jsxs)(n.C, {
                        animate: "fadein",
                        ...
                        children: [(0, c.jsx)(n.C, {
                            ...
                            children: (0, c.jsx)(n.M, {
                                title: C.instructionScreen.title
                            })
                        }), (0, c.jsx)(n.C, {
                            style: {
                                paddingTop: 0,
                                paddingBottom: n.s.xl
                            },
                            flex: "column",
                            px: "compact" === i ? "lg" : "xxl",
                            center: "y",
                            expand: !0,
                            children: "idle" === x ? (0, c.jsxs)(c.Fragment, {
                                children: [d && (0, c.jsx)(n.C, {
                                    flex: "row",
                                    center: "x",
                                    animate: "fadein",
                                    py: "3xl",
                                    ...
                                    multiline: !0,
                                    balance: !0,
                                    children: C.instructionScreen.instruction
                                }), (0, c.jsx)(n.S, {
                                    y: "lg"
                                }), (0, c.jsx)(n.B, {
                                    fullWidth: !0,
                                    ...
                                    children: C.instructionScreen.signInButton
                                }), (0, c.jsx)(n.S, {
                                    y: "sm"
                                }), (0, c.jsx)(n.B, {
                                    fullWidth: !0,
                                    ...
                                    children: C.instructionScreen.disconnectWallet
                                })]
                            }) : (0, c.jsxs)(c.Fragment, {
                                children: [d && (0, c.jsx)(n.C, {
                                    py: "3xl",
                                    children: (0, c.jsx)(I.W, {
                                        error: "failed" === x,
                                        iconUrl: d.meta.iconURL
                                    }, String(N))
                                }), (0, c.jsxs)(n.C, {
                                    flex: "column",
                                    gap: "md",
                                    ...
                                    children: [(0, c.jsx)(n.T, {
                                        ...
                                        center: !0,
                                        color: "primaryText",
                                        children: "failed" === x ? C.signingScreen.failedToSignIn : C.signingScreen.inProgress
                                    }), "signing" === x && (0, c.jsx)(n.T, {
                                        center: !0,
                                        multiline: !0,
                                        balance: !0,
                                        children: T ? (0, c.jsx)(eW, {}) : (0, c.jsx)(c.Fragment, {
                                            children: C.signingScreen.prompt
                                        })
                                    }), T && "signing" === x && (0, c.jsxs)(n.C, {
                                        children: [(0, c.jsx)(n.S, {
                                            y: "sm"
                                        }), (0, c.jsxs)(n.B, {
                                            fullWidth: !0,
                                            variant: "accent",
                                            onClick: () => {
                                                window.open(`https://app.safe.global/transactions/queue?safe=${w}:${L}`, "_blank")
                                            },
                                            style: {
                                                gap: n.s.xs,
                                                alignItems: "center"
                                            },
                                            children: [" ", C.signingScreen.approveTransactionInSafe, (0, c.jsx)(s.h0n, {
                                                width: n.a.sm,
                                                height: n.a.sm
                                            })]
                                        })]
                                    }), "failed" === x && (0, c.jsxs)(n.C, {
                                        children: [(0, c.jsx)(n.S, {
                                            y: "sm"
                                        }), (0, c.jsxs)(n.B, {
                                            fullWidth: !0,
                                            ...
                                            children: [(0, c.jsx)(s.BGW, {
                                                width: n.a.sm,
                                                height: n.a.sm
                                            }), C.signingScreen.tryAgain]
                                        }), (0, c.jsx)(n.S, {
                                            y: "sm"
                                        }), (0, c.jsx)(n.B, {
                                            fullWidth: !0,
            ...
            function eW() {
                let e = (0, n.c)().connectWallet.signatureScreen.signingScreen,
                    {
                        getWalletConfig: t
                    } = (0, l.tNP)(),
                    i = (0, l.Osb)(),
                    s = i ? .getPersonalWallet(),
                    a = s && t(s) ? .isHeadless;
                return (0, c.jsx)(c.Fragment, {
                    children: a ? (0, c.jsx)(c.Fragment, {
                        children: e.approveTransactionInSafe
                    }) : (0, c.jsx)(c.Fragment, {
                        children: e.promptForSafe
                    })
                })
            }
            ...
            function eB(e) {
                let {
                    signIn: t,
                    status: i
                } = e, a = (0, n.c)().connectWallet.signatureScreen.signingScreen, l = (0, r.useRef)(!1);
                return (0, r.useEffect)(() => {
                    l.current || (l.current = !0, t())
                }, [t]), (0, c.jsxs)(n.C, {
                    p: "lg",
                    fullHeight: !0,
                    flex: "column",
                    ...
                    children: [(0, c.jsx)(n.M, {
                        ...
                        children: "failed" === i ? (0, c.jsxs)(n.C, {
                            flex: "column",
                            gap: "lg",
                            color: "danger",
                            center: "both",
...
`, eP = (0, n.b)(() => ({
                ...
                "&::before": {
                    ...
                    bottom: 0,
                    right: 0,
                    background: (0, n.u)().colors.accentText,
                    animation: `${eQ} 2s cubic-bezier(0.175, 0.885, 0.32, 1.1) infinite`,
                    zIndex: -1,
                    borderRadius: n.r.xl
                }
            })), eG = "tw-connect-wallet";
            ...
            function eH(e) {
                let t = (0, l.Osb)(),
                    ...
                    o = (0, n.c)(),
                    C = (0, l.rBi)(),
                    d = "connecting" === a || "unknown" === a,
                    M = e.btnTitle || o.connectWallet.defaultButtonTitle,
                    j = (0, n.o)(),
                    x = (0, r.useContext)(n.P),
                    g = (0, l.Jgv)(),
                    {
                        logout: u
                    } = (0, l.aU_)(),
                    ...
                    I = !!g ? .authUrl && !!T && (!m ? .address || T !== m ? .address),
                    L = !e.auth ? .loginOptional && I,
                    w = (0, r.useMemo)(() => {
                        if (!e.supportedTokens) return U;
                        let t = { ...U
                        };
                ...
                return (0, r.useEffect)(() => {
                    ...
                    children: [(0, c.jsx)(q, {
                    ...
                    }), t ? e.switchToActiveChain && N && h ? (0, c.jsx)(eF, {
                        style: e.style,
                        className: e.className,
                        switchNetworkBtnTitle: e.switchNetworkBtnTitle
                    }) : L ? (0, c.jsx)(n.B, {
                        variant: "primary",
                        onClick: () => {
                            t && y(!0)
                        ...
                        "data-theme": s,
                        className: `${eG}--sign-in ${e.className||""}`,
                        style: {
                            minWidth: "140px",
                            ...e.style
                        },
                        ...
                        children: (0, c.jsxs)(n.C, {
                            ...
                            children: [(0, c.jsx)(eZ, {
                                ...
                                children: [" ", o.connectWallet.signIn, " "]
                            })]
                        })
                    }) : (0, c.jsx)(eS, {
                        theme: s,
                        ...
                        onDisconnect: () => {
                            g ? .authUrl && (u(), e ? .auth ? .onLogout ? .())
                        },
                        hideSwitchToPersonalWallet: e.hideSwitchToPersonalWallet,
                        hideDisconnect: e.hideDisconnect
                    }) : (0, c.jsx)(eR, {
                        disabled: d,
                        className: `${e.className||""} ${eG}`,
                        "data-theme": s,
                        "data-is-loading": d,
                        variant: "primary",
                        type: "button",
                        ...
                        "aria-label": "connecting" === a ? o.connectWallet.connecting : M,
                        onClick: () => {
                            let t = e.modalSize || "wide";
                            ((0, n.i)() || 1 === C.length) && (t = "compact"), x({
                                title: e.modalTitle || o.connectWallet.defaultModalTitle,
                                theme: s,
                                data: void 0,
                                modalSize: t,
                                termsOfServiceUrl: e.termsOfServiceUrl,
            ...
            function eF(e) {
                let {
                    activeChain: t
                } = (0, l.tNP)(), i = (0, l.o$C)(), [s, a] = (0, r.useState)(!1), o = (0, n.c)(), C = e.switchNetworkBtnTitle ? ? o.connectWallet.switchNetwork;
                return (0, c.jsx)(eR, {
                    className: `${eG}--switch-network ${e.className||""}`,
                    variant: "primary",
                    type: "button",
                    "data-is-loading": s,
                    ...
                    "aria-label": s ? o.connectWallet.switchingNetwork : void 0,
                    children: s ? (0, c.jsx)(n.e, {
                        size: "sm",
                        color: "primaryButtonText"
                    }) : C
                })
            ...
            function eX() {
                let {
                    ...
                    privacyPolicyUrl: t,
                    welcomeScreen: i
                } = (0, r.useContext)(n.g), s = (0, n.c)().connectWallet;
                if (i && "function" == typeof i) return (0, c.jsx)(i, {});
                let a = ("object" == typeof i ? i ? .title : void 0) || s.welcomeScreen.defaultTitle,
                    l = ("object" == typeof i ? i ? .subtitle : void 0) || s.welcomeScreen.defaultSubtitle,
...
`, e$ = (0, n.b)(() => {
                ...
                return {
                    color: e.colors.accentText,
                    filter: `drop-shadow(0px 6px 10px ${e.colors.accentText})`,
                    animation: `${eJ} 2s ease infinite alternate`
                }
            }), e_ = e => {
                let {
                    screen: t,
                    ...
                    onShow: C,
                    onClose: d
                } = e, M = (0, l.rBi)(), j = (0, l.pX8)(), x = (0, l.qL0)(), g = (0, r.useContext)(n.g), u = (0, r.useContext)(n.P), N = g.title, h = g.theme, D = g.modalSize, y = g.onConnect, T = "wide" === D, {
                    user: m
                } = (0, l.aFb)(), L = (0, l.Jgv)(), w = (0, r.useCallback)(() => {
                    y && y();
                    let e = !g.auth ? .loginOptional && !!L ? .authUrl && !m ? .address;
                    (0, a.o)(() => {
                        C()
                    }), e ? i(a.r.signIn) : d()
                }, [g.auth ? .loginOptional, L ? .authUrl, m ? .address, i, C, d, y]), z = (0, r.useCallback)(() => {
                    i(s), "connecting" === j && x()
                }, [i, s, j, x]), p = (0, l.$4A)(), S = (0, l.SFn)(), {
                    setConnectionStatus: A,
                    setConnectedWallet: b,
                    createWalletInstance: f,
                    activeWallet: E
                } = (0, l.tNP)(), k = (0, c.jsx)(n.Q, {
                    title: N,
                    walletConfigs: M,
                    onGetStarted: () => {
                        i(a.r.getStarted)
                    ...
                    let i = t.connectUI || I.H;
                    return (0, c.jsx)(i, {
                        supportedWallets: M,
                        theme: "string" == typeof h ? h : h.type,
                        goBack: z,
                        connected: w,
                        isOpen: e.isOpen,
                        show: C,
                        hide: o,
                        walletConfig: t,
                        modalSize: g.modalSize,
                        selectionData: g.data,
                        connect: e => p(t, e),
                        setConnectionStatus: A,
                        setConnectedWallet: b,
                        createWalletInstance: () => f(t),
                        connectionStatus: j,
                        connectedWallet: E,
                        connectedWalletAddress: S,
                        setSelectionData: e => {
                            u(t => ({ ...t,
                                data: e
                            }))
                ...
                return (0, c.jsx)(a.S.Provider, {
                    ...
                    children: T ? (0, c.jsxs)("div", {
                        ...
                        children: [(0, c.jsxs)(eq, {
                            children: [" ", k, " "]
                        }), (0, c.jsxs)(n.C, {
                            flex: "column",
                            scrollY: !0,
                            relative: !0,
                            children: [t === a.r.signIn && U, t === a.r.main && (0, c.jsx)(c.Fragment, {
                                children: Y
                            }), t === a.r.getStarted && Y, "string" != typeof t && O(t)]
                        })]
                    }) : (0, c.jsxs)(n.C, {
                        flex: "column",
                        scrollY: !0,
                        ...
                        children: [t === a.r.signIn && U, t === a.r.main && k, t === a.r.getStarted && Y, "string" != typeof t && O(t)]
                    })
                })
            }, eK = () => {
                let {
                    ...
                    setScreen: s,
                    initialScreen: o
                } = (0, a.h)(), C = (0, n.n)(), d = (0, n.o)(), [M, j] = (0, r.useState)(!1), x = (0, l.pX8)(), g = (0, r.useCallback)(() => {
                    d(!1), (0, a.o)(() => {
                        s(o)
                    })
                }, [o, d, s]), [u, N] = (0, r.useState)(x);
                (0, r.useEffect)(() => {
                    N(x)
                }, [x]);
                let h = (0, l.qL0)(),
                    D = (0, l.Osb)(),
                    y = !!D ? .getPersonalWallet(),
                    T = "string" != typeof i && !!i.personalWallets;
                (0, r.useEffect)(() => {
                    y || !T || C || "connected" !== x || "connecting" !== u || d(!0)
                }, [C, x, d, T, y, u]), (0, r.useEffect)(() => {
                    C || (0, a.o)(() => {
                        j(!1)
                    })
                }, [C, d, i]);
                let m = (0, r.useCallback)(() => j(!0), []),
                    I = (0, r.useCallback)(() => j(!1), []);
                return (0, r.useEffect)(() => {
                    C && i === a.r.signIn && !D && (s(o), d(!1))
                }, [o, C, i, d, s, D]), (0, c.jsx)(n.H, {
                    theme: e,
                    children: (0, c.jsx)(q, {
                        hide: M,
                        size: t,
                ...
                return {
                    ...
                    ...n.G,
                    position: "relative",
                    borderRight: `1px solid ${e.colors.separatorLine}`
                }
            });
            (0, M.F4)
            `
...
`;
            ...
            let e2 = e => {
                ...
                "undefined" == typeof globalThis ? (e0.name, e0.version, (0, n.U)()) : void 0 === globalThis.X_SDK_NAME && (globalThis.X_SDK_NAME = e0.name, globalThis.X_SDK_PLATFORM = "browser", globalThis.X_SDK_VERSION = e0.version, globalThis.X_SDK_OS = (0, n.U)(), globalThis.APP_BUNDLE_ID = void 0);
                let d = t || I.d,
                    M = o || "dark",
                    j = (0, r.useMemo)(() => a ? e1(a) : void 0, [a]),
                    x = (0, r.useRef)(!1);
                return (0, r.useEffect)(() => {
                    x.current || (x.current = !0, (async () => {
                        if (d.find(e => e.id === y.w.embeddedWallet) && C.clientId) {
                            let {
                                EmbeddedWalletSdk: e
                            } = await Promise.resolve().then(i.bind(i, 76227));
                            new e({
                                clientId: C.clientId,
                                chain: "Ethereum"
                            })
                ...
                }, [C.clientId, d]), (0, c.jsx)(n.V.Provider, {
                    value: C.locale || (0, n.m)(),
                    children: (0, c.jsx)(n.R, {
                        theme: M,
                        children: (0, c.jsx)(n.H, {
                            theme: M,
                            children: (0, c.jsxs)(l.gtM, { ...C,
                                theme: "string" == typeof M ? M : M.type,
                                supportedWallets: d,
                                signerWallet: j,
                                children: [s, (0, c.jsx)(eK, {})]
                            })
                        })
                    })
                })
